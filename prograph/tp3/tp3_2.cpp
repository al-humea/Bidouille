...
class Viewer: public EZCOGL::GLViewer
{
	...
	EZCOGL::MeshRenderer::UP plane_rend;
	float tps;
	EZCOGL::Texture2D::SP tex;
    std::vector<EZCOGL::GLVec4>  colorMap = {{0.0,        0.6372549,  0.88823529, 1.0},
...
void Viewer::init_ogl()
{
	...
	tex->load(DATA_PATH + "/heightmap.png", false);
	// ***********************************
	// Geometry
	// ***********************************
	auto meshPlane = EZCOGL::Mesh::Grid(100, 100);
	plane_rend = meshPlane->renderer(1, -1, 2, -1, -1);
...
void Viewer::draw_ogl()
{
	...
	const EZCOGL::GLMat4& model = EZCOGL::Transfo::scale(4.f) * EZCOGL::Transfo::rotateX(-60);
	// ***********************************
	// Rendering
	// ***********************************
    ...
    EZCOGL::set_uniform_value(3, colorMap);
	// 1st pass : Draw Points
	plane_rend->draw(GL_TRIANGLES);
}
...
void Viewer::interface_ogl()
{
	...
	if (ImGui::Button("Reload shaders"))
		shaderPrg = EZCOGL::ShaderProgram::create({{GL_VERTEX_SHADER, EZCOGL::load_src(SHADERS_PATH + "/TP3_2.vs")}, {GL_FRAGMENT_SHADER, EZCOGL::load_src(SHADERS_PATH + "/TP3_2.fs")}}, "Isle");
